...
using BussinessLayer.MSMQServices;
...
namespace EmployeeManagementCoreApi.Controllers
{
    ...
    public class AdminController : ControllerBase
    {
        ...
        public IActionResult RegisterAdmin(RegisterModel admin)
        {
            try
            {
                ...
                {
                    this.mSMQ.AddToQueue("In admin controller, added date is "+DateTime.Now+" "+admin.Email + " has been registered sucessfully");
